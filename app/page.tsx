...
const APPS: AppItem[] = [
  ...
  { id: "marketing", name: "마케팅", category: ["Admin"], icon: ShoppingBag, url: "https://script.google.com/macros/s/AKfycbwaaA5fhmo2AEwzUujxrxrNsvtHIigo9LYPuVRAFIF4UjW11mOsqoZVVToUjSZ5W8te/exec", favorite: true },
];
